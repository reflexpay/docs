...
<CardGroup cols={2}>
  ...
  <Card title="Wallet Credit and Debit" icon="wallet">
    Provision wallets with KYC, move funds, create dynamic accounts, and reverse wallet transactions
  </Card>
  <Card title="Webhook Notifications" icon="webhook">
    Receive partner transaction and wallet debit or credit events in real time
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet API" icon="wallet" href="/partner/wallet">
    Retrieve your partner wallet, provision scoped wallets, view summaries, move funds, create dynamic accounts, and reverse wallet transactions
  </Card>
  <Card title="Webhooks" icon="webhook" href="/partner/webhooks">
    Receive transaction status and wallet debit or credit event notifications
  </Card>
  <Card title="Transactions API" icon="exchange" href="/partner/transaction">
    Gateway transaction management, reporting, and wallet credit/debit flows
  </Card>
</CardGroup>
...
<Note>
  Wallet retrieval, provisioning, transfer, dynamic account, and transaction reversal endpoints are available under the dedicated Wallet API using partner authentication and, where applicable, a partner wallet reference.
</Note>

<Note>
  Partners can also configure a webhook URL to receive `transaction.status`, `wallet.debited`, and `wallet.credited` notifications.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet Operations" icon="wallet">
    Retrieve your partner wallet and perform institution-scoped provisioning, debit, credit, summary, dynamic account, and reversal operations on linked wallets
  </Card>
  <Card title="Webhook Automation" icon="webhook">
    Automate reconciliation and notifications using partner webhook callbacks
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet API" icon="wallet" href="/partner/wallet">
    Explore scoped wallet operations and refunds
  </Card>
  <Card title="Webhooks" icon="webhook" href="/partner/webhooks">
    Implement partner event callbacks
  </Card>
  <Card title="Transactions API" icon="exchange" href="/partner/transaction">
