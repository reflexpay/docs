...
<CardGroup cols={2}>
  ...
  <Card title="Wallet API" icon="wallet" href="/partner/wallet">
    Provision scoped wallets, view summaries, move funds, create dynamic accounts, and reverse wallet transactions
  </Card>
...
<Note>
  Wallet provisioning, transfer, dynamic account, and transaction reversal endpoints are available under the dedicated Wallet API using partner authentication and a partner wallet reference.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet Operations" icon="wallet">
    Perform institution-scoped provisioning, debit, credit, summary, dynamic account, and reversal operations on linked wallets
  </Card>
