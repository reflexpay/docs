...
<CardGroup cols={2}>
  ...
  <Card title="Wallet Credit and Debit" icon="wallet">
    Move funds between partner wallet and authenticated customer wallets
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet API" icon="wallet" href="/partner/wallet">
    Retrieve wallet references, view summaries, move funds, and issue refunds
  </Card>
...
<Note>
  Wallet transfer and refund endpoints are available under the dedicated Wallet API using partner authentication and a partner wallet reference.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Wallet Operations" icon="wallet">
    Perform institution-scoped debit, credit, summary, and refund operations on linked wallets
  </Card>
