...
The FLEX PayTag SSO API enables institutions and partners to create PayTags for their customers on the FLEX ecosystem. Users with PayTag can also connect their existing PayTag. Your customers can then transact with any other PayTag user across the entire FLEX network, regardless of which partner they come from—creating a truly interconnected payment ecosystem.
...
<CardGroup cols={2}>
  ...
  <Card title="Transactions" icon="exchange" href="/sso/transaction">
    P2P, withdrawals, bank transfers, and statements
  </Card>
  <Card title="Payment Requests" icon="file-invoice" href="/sso/payment-request">
    Create, accept, decline, and cancel payment requests
  </Card>
  <Card title="PayTag" icon="at" href="/sso/paytag-lookup">
    Search and resolve PayTag profiles
  </Card>
  <Card title="Beneficiaries" icon="users" href="/sso/beneficiary">
...
<CardGroup cols={2}>
  <Card title="Wallet Flutter SDK" icon="mobile-screen-button" href="/sdk/wallet">
    Embed onboarding, login, wallet, transfers, history, and QR flows with `flex_sdk`.
  </Card>
  <Card title="API-led integration" icon="code" href="/sso/integration-guide">
    Build your own wallet experience on top of the PayTag SSO API.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Flutter SDK" icon="mobile-screen-button" href="/sdk/wallet">
    Embed the PayTag SSO experience in your Flutter app
  </Card>
