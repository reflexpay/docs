...
description: "Build with FLEX APIs for PayTag SSO, merchant collections, partner gateway flows, and switching services."
---
...
<Card icon="rocket" horizontal href="/sso/index" title="Start with PayTag SSO">
...
<CardGroup cols={2}>
  <Card icon="wallet" href="/sso/index" title="PayTag SSO">
  ...
  <Card icon="arrows-rotate" href="/switch/index" title="Switching service">
...
<CardGroup cols={2}>
  ...
  <Card icon="scale-balanced" href="/switch/payments" title="Settlement-aware switching">
...
<Steps>
  <Step title="Pick your product surface">
    Choose **PayTag SSO**, **Merchant API**, **Partner API**, or **Switching service** based on your business model.
  </Step>
...
<CardGroup cols={2}>
  <Card icon="file-code" href="/api-reference/paytag-sso" title="PayTag SSO API reference">
